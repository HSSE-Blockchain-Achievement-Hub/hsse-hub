...
const subscribers_contract = new web3.eth.Contract(subscribers_json['abi'], subscribers_address);
const super_users_contract = new web3.eth.Contract(super_user_json['abi'], super_users_address);
